...
tslib_1.__decorate([
    rest_1.post('/customers', {
        responses: {
            '200': {
                ...
                content: { 'application/json': { schema: rest_1.getModelSchemaRef(models_1.Customer) } },
            },
        },
    }),
    tslib_1.__param(0, rest_1.requestBody({
        content: {
            'application/json': {
                schema: rest_1.getModelSchemaRef(models_1.Customer, {
                    title: 'NewCustomer',
                }),
            },
        },
    ...
    tslib_1.__metadata("design:paramtypes", [models_1.Customer]),
            ...
            '200': {
                ...
                content: {
                    'application/json': {
                        schema: {
                            type: 'array',
                            items: rest_1.getModelSchemaRef(models_1.Customer, { includeRelations: true }),
                        },
                    },
                },
            },
...
tslib_1.__decorate([
    ...
    tslib_1.__param(0, rest_1.requestBody({
        content: {
            'application/json': {
                schema: rest_1.getModelSchemaRef(models_1.Customer, { partial: true }),
            },
        },
    })),
    ...
    rest_1.get('/customers/{id}', {
        responses: {
            '200': {
                ...
                content: {
                    'application/json': {
                        schema: rest_1.getModelSchemaRef(models_1.Customer, { includeRelations: true }),
                    },
                },
            },
        },
