...
tslib_1.__decorate([
    ...
    tslib_1.__param(0, rest_1.requestBody({
        content: {
            'application/json': {
                schema: rest_1.getModelSchemaRef(models_1.Role, {
                    title: 'NewRole',
                }),
            },
        },
...
tslib_1.__decorate([
    ...
    tslib_1.__param(0, rest_1.requestBody({
        content: {
            'application/json': {
                schema: rest_1.getModelSchemaRef(models_1.Role, { partial: true }),
            },
        },
    })),
    ...
    rest_1.get('/roles/{id}', {
        responses: {
            '200': {
                ...
                content: {
                    'application/json': {
                        schema: rest_1.getModelSchemaRef(models_1.Role, { includeRelations: true }),
                    },
                },
            },
        },
